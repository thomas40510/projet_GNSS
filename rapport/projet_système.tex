...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textsc{Arango}, \textsc{Chikhi}, \textsc{Simpore}, \textsc{Prévost}}
\fancyhead[C]{}
...
\author{Paco \textsc{Arango}, Tom \textsc{Chikhi}, Sheick \textsc{Simpore}, \\Thomas \textsc{Prévost}}
\date{\today}
...
\imgGarde{\includegraphics[width=.4\textwidth]{imgs/illus}}
...
\maketitle
   ...
   \include{corps/acquisition}

   \include{corps/exploitation-path}

   \include{corps/satellites}
